-- v99: Ensure ALL premium layouts (including animated: matrix, liquid, supernova, tapewave, phoenix)
-- are allowed by profile_settings_layout_check.
-- Safe to re-run if v96/v97 were partially applied.
