...
export function HomePreview() {
  return (
    <section id="preview" className="mx-auto max-w-md px-6 pb-24">
      <div className="bf-home-preview rounded-2xl border border-white/[0.08] bg-[#141414]/80 p-6 shadow-[0_24px_80px_rgba(0,229,204,0.08)] backdrop-blur-xl">
        <div className="flex items-center gap-4">
          <div className="bf-home-preview-avatar relative h-14 w-14 shrink-0 rounded-full bg-[#1a1a1a] ring-1 ring-white/[0.08]">
            <div className="absolute inset-0 rounded-full bg-[radial-gradient(circle_at_30%_25%,rgba(0,229,204,0.35),transparent_65%)]" />
          </div>
