...
export function mergeSettings(
  ...
  return normalizeEnterGateMediaFields(
    ...
    hide_profile_handle: row?.hide_profile_handle ?? DEFAULT_SETTINGS.hide_profile_handle,
    ...
    show_total_followers: row?.show_total_followers ?? DEFAULT_SETTINGS.show_total_followers,
